...
nba_data %>%
  ...
  ggplot() +
  aes(x = year_id, y = average_3PA) +
  geom_point(shape = 21, fill = "dodgerblue", color = "black", size = 2) +
  labs(x = "NBA Season/Year", y = "Share of Attempts that were Three-pointers", title = "Have NBA Players Really Started Shooting more Threes?") +
  theme_light()
```
<br>
### Answer
